...
const Options: React.FC = () => {
    ...
    const cycleShaders = () => {
        ...
        setSynchronizedShaderName(newShaderName);
    ...
    return (
        <div className="flex items-center flex-col p-5 w-screen	h-screen bg-white dark:bg-gray-900 antialiased">
            ...
            {showPreview && <><p className="my-4 text-lg text-gray-500">Preview ({synchronizedShaderName})</p><video ref={videoElement} className="max-w-96 max-h-96 rounded-lg" playsInline autoPlay muted/></>}
