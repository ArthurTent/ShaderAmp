# Shader Credits
## nyan cat visualizer
![ ](../images/preview/nyan_cat_visualizer.frag.png)

Author: MrHAX00

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/stXcz8
...
![ ](../images/preview/knightrider.frag.png)

Author: knarkowicz

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/4ldGz4
...
![ ](../images/preview/StarTrekInAShader.frag.png)

Author: msm01

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/3cdGD4
...
## LHC
![ ](../images/preview/LHC.frag.png)

Author: orblivius

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/3XXyDH
...
## Things (Audio & Shapes)
![ ](../images/preview/things_audio_and_shapes.frag.png)

Author: ArthurTent

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/7cfSWs
...
## Waveform Music [445]
![ ](../images/preview/WaveformMusic.frag.png)

Author: Xor

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/wfcGR2
...
## Neon World
![ ](../images/preview/NeonWorld.frag.png)

Author: zguerrero

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/MlscDj
...
## Christmas tree ::)
![ ](../images/preview/Christmas_tree.frag.png)

Author: vanshika

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/MfGBWm

License: Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License

License URL: https://creativecommons.org/licenses/by-nc-sa/3.0/

## Mandelbrot Multiverse
![ ](../images/preview/MandelbrotMultiverse.frag.png)

Author: Microfractal

Modified by: Arthur Tent and Microfractal @38c3

Shader URL: https://www.shadertoy.com/view/4Xt3RX
...
## ripplelppir
![ ](../images/preview/ripplelppir.frag.png)

Author: bombblob

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/w3sGR7
...
## vt220 at night
![ ](../images/preview/vt220_at_night_v3.frag.png)

Author: sprash3

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/lt2SDK

License: Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License

License URL: https://creativecommons.org/licenses/by-nc-sa/3.0/

## ♫ [MAGFest] Station event
![ ](../images/preview/[MAGFest]StationEvent.frag.png)

Author: patu

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/4llfDs
...
## tHe gRiD
![ ](../images/preview/tHegRiD.frag.png)

Author: z0rg

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/7tGfWy

License: Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License

License URL: https://creativecommons.org/licenses/by-nc-sa/3.0/

## Fork Waveform [Orblivionized]
![ ](../images/preview/ForkWaveform[Orblivionized].frag.png)

Author: orblivius

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/3c3XzS
...
## Call of the Siren 
![ ](../images/preview/CallOfThesiren.frag.png)

Author: Quasimondo

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/7sSSDd
...
## Eye of Haji Sauron
![ ](../images/preview/EyeOfHajiSauron.frag.png)

Author: arminkz

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/X3jcWR
...
## Dodeca, icosa & stellations
![ ](../images/preview/DodecaIcosaAndStellations.frag.png)

Author: ChunderFPV

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/McsXz8
...
## Habitable Planet
![ ](../images/preview/HabitablePlanet.frag.png)

Author: Kali

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/WdScRW
...
## Cosmic scene
![ ](../images/preview/AudioCosmicScene.frag.png)

Author: Thominator

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/Xl3fWr
...
## everyday 022/100
![ ](../images/preview/EverydaySkeletons_c-base.frag.png)
...
## Turbulent Flame vs Glasshawk
![ ](../images/preview/TurbulentFlameVsGlasshawk.frag.png)

Author: Cotterzz

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/tfjXWK
...
## The Popular Shader
![ ](../images/preview/ThePopularShader.frag.png)
...
## Cozy Cabin TV
![ ](../images/preview/CozyCabinTV.frag.png)

Author: ArthurTent

Modified by: ShaderAmp Converter

Shader URL: https://www.shadertoy.com/view/N3fXD8
...
## Audio Band EQ Demo
![ ](../images/preview/AudioBandEQDemo.frag.png)

Author: byt3_m3chanic

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/WfByz1
...
![ ](../images/preview/InteractiveCubes.frag.png)

Author: ShaderAmp Team

Modified by: ArthurTent

Shader URL: https://github.com/ArthurTent/ShaderAmp
...
## échappatoire
![ ](../images/preview/echappatoire_with_heart.frag.png)

Author: sukupaper

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/7lBXRG
...
## new colorful galaxy
![ ](../images/preview/new_colorful_galaxy.frag.png)

Author: nayk

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/l3fczr
...
## Merry Christmas! [388 chars]
![ ](../images/preview/MerryChristmasKishimisu.frag.png)

Author: kishimisu

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/4fs3WS
...
![ ](../images/preview/i_dont_know.frag.png)

Author: xbvuno

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/43KBRK
...
## Mind flowers
![ ](../images/preview/MindFlowers.frag.png)

Author: mrange

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/DlB3WG
...
![ ](../images/preview/MoreGlowExperiments.frag.png)

Author: mrange

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/W3X3zl
...
## Audiophile campfire at night
![ ](../images/preview/Audiophilecampfireatnight.frag.png)

Author: ArthurTent

Modified by: ShaderAmp Converter

Shader URL: https://www.shadertoy.com/view/NXXSWH
...
## Musical Heart
![ ](../images/preview/JamSession.frag.png)

Author: Passion

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/XdsyW4
...
## Keyboard Input Test
![ ](../images/preview/KeyboardInputTest.frag.png)

Author: ShaderAmp Development
...
## Speaker visualizer
![ ](../images/preview/Speakervisualizer.frag.png)

Author: jaszunio15

Modified by: ShaderAmp Converter

Shader URL: https://www.shadertoy.com/view/wsdXDN
...
## Mystic Flower interactive
![ ](../images/preview/MysticFlowerInteractive.frag.png)

Author: timmaffett 

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/mdjGDc
...
## Electric Dream
![ ](../images/preview/ElectricDream.frag.png)

Author: mu6k

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/ld23Wd
...
## Fractal Land
![ ](../images/preview/FractalLand.frag.png)

Author: Kali

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/XsBXWt
...
## tardigrade 
![ ](../images/preview/tardigrade.frag.png)

Author: zguerrero

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/ldcyW4
...
## Custom Uniform Demo
![ ](../images/preview/CustomUniformDemo.frag.png)
...
![ ](../images/preview/AHugeEverGrowing.frag.png)

Author: orblivius

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/W3SfRy
...
## Fork: Neural Stanford c-base
![ ](../images/preview/nn_c.frag.png)

Author: ArthurTent

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/4fyfzK
...
## A Gift For You
![ ](../images/preview/AGiftForYou.frag.png)

Author: ArthurTent

Modified by: ShaderAmp Converter

Shader URL: https://www.shadertoy.com/view/73fXW2
...
## Ribbons
![ ](../images/preview/Ribbons.frag.png)

Author: XT95

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/lds3zr
...
## [SH18] BabyToy
![ ](../images/preview/[TWITCH]GenuaryNr02_Flopine.frag.png)
...
## LCARS Display
![ ](../images/preview/LCARSDisplay.frag.png)

Author: Xibanya

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/std3RH
...
![ ](../images/preview/another_synthwave_sunset_thing.frag.png)

Author: stduhpf

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/tsScRK
...
## Tomb World of Silicon Beats
![ ](../images/preview/TombWorldOfSiliconBeats.frag.png)

Author: mrange

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/tcKBR3
...
## 🎵Fix for broken SoundCloud URLs
![ ](../images/preview/FixForBrokenSoundCloudURLs.frag.png)

Author: cf

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/MfKcR3
...
![ ](../images/preview/Fork_Complicating_things_even_further.frag.png)
...
## Nyan Cat Audio Rainbow
![ ](../images/preview/NyanCatAudioRainbow.frag.png)

Author: EyeOfPython

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/W3BfRw
...
## Glowest
![ ](../images/preview/Glowest.frag.png)

Author: TornaxO7

Modified by: ArthurTent

Shader URL: https://www.shadertoy.com/view/w3tcWr
